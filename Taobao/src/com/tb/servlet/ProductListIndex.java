...
import com.tb.utils.PageNaverUtils;
import com.tb.utils.PageSet;
import com.tb.utils.HttpUtil;

public class ProductListIndex extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		PageSet pSet = product.getProductList(pno, 15);
		...
		HttpUtil.show(request, response, "productlist.jsp");
	}
